namespace ExpressPackingMonitoring.ViewModels
{
    ...
    {
        /// <summary>
        /// 下限只用来防极端值：发布尺寸以预览控件的**实际显示宽度**为准（向上吸附到比例步长），
        /// 主界面和小窗都是这个规则。
        ///
        /// 原来是 640，小窗控件只有 340px 宽却按 640 发布，白白多搬一倍多像素，
        /// 小窗模式的预览开销几乎和主界面一样（现场反馈"小窗占用为什么不比主界面小"）。
        /// 现在除非控件本身小于 64px（不存在的窗口尺寸），发布尺寸都跟着控件走。
        /// </summary>
        internal const int MinimumWidth = 64;
