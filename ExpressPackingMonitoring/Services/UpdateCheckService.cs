...
namespace ExpressPackingMonitoring.Services
{
    ...
    public sealed class UpdateCheckService
    {
        ...
        internal async Task<UpdateCheckResult> FetchLatestReleaseAsync(CancellationToken cancellationToken)
        {
            ...
            using ResolvedUpdateRelease resolved = await metadataClient.FetchLatestReleaseWithAssetAsync(
                UpdateCheckOptions.ToReleaseListUrls(UpdateCheckOptions.GetUpdateCheckUrls()),
                UpdateReleaseSelection.PlatformAssetPredicate(OperatingSystem.IsMacOS()),
                cancellationToken);
