...
try {
    ...
    Invoke-Checked -FilePath "node" -Arguments @("--check", "docs\examples\extension-v1-minimal.js")
    ...
    try {
        ...
        if (-not $wpfProcess.MainWindowTitle.StartsWith("PackingProof 备份主机", [System.StringComparison]::Ordinal)) {
